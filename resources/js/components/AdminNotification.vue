...
<li class="nav-item dropdown no-arrow mx-1">
    ...
    <!-- Dropdown - Alerts -->
    <div v-if="unreadCount > 0" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
      ...
      :key="item.id" :href="`/admin/post_comments/${item.data.id}/edit`" @click="readNotifications(item)"
