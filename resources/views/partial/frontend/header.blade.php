            ...
            <div class="col-lg-8 d-none d-lg-block">
                <nav class="mainmenu__nav">
                    <ul class="meninmenu d-flex justify-content-start">
                        ...
                        <li class="drop with--one--item"><a href="{{ route('page.show','about-us') }}">About Us</a></li>
                        <li class="drop with--one--item"><a href="{{ route('page.show','our-vision') }}">Our vision</a></li>
            ...
            <div class="col-lg-12 d-none">
                <nav class="mobilemenu__nav">
                    <ul class="meninmenu">
                        ...
                        <li><a href="{{ route('page.show','our-vision') }}">Our Vision</a></li>
...
<div class="box-search-content search_active block-bg close__top">
    ...
    {!! Form::open(['route'=>'frontend.search', 'method'=>'get','class'=>'minisearch','id'=>'search_mini_form']) !!}
        <div class="field__search">
            {!! Form::text('keyword', old('keyword',request()->keyword), ['placeholder'=>'Search entire store here...']) !!}
             <div class="action">
                <a href="javascript:vaid(0)"
                onclick="event.preventDefault(); document.getElementById('search_mini_form').submit();"
