...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Edit supervisor ({{ $user->username }})</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    {!! Form::select('permissions[]', [] + $supervisors->toArray(), old('permissions',$userPermission) ,
                        ['class'=>'select-multiple-tags form-control' ,'multiple' => 'multiple']) !!}
                    @error('permissions')
                        <span class="text-danger">{{ $mesaage }}</span>
                    @enderror
                </div>
